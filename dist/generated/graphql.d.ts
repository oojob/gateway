...
export declare type PermissionsBase = {
...
export declare enum ProfileOperationOptions {
    Create = "CREATE",
    Read = "READ",
    Update = "UPDATE",
    Delete = "DELETE",
...
export declare type QueryReadProfileArgs = {
    input: IdInput;
};
...
export declare type ValidateUsernameInput = {
    username?: Maybe<Scalars['String']>;
};
...
export declare type QueryResolvers<ContextType = OoJobContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
    ...
    ReadProfile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType, RequireFields<QueryReadProfileArgs, 'input'>>;
}>;
